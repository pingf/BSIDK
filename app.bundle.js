...
},{"./tags/dt3.tag":5,"./tags/hello.tag":6,"./tags/hello2.tag":7,"./tags/m_button.tag":8,"./tags/sel.tag":9,"./tags/test.tag":10,"./tags/todo.tag":11,"./tags/todo2.tag":12,"./tags/weight_item.tag":13,"./tags/weight_list.tag":14,"d3":2,"jquery":3,"riot":4}],2:[function(require,module,exports){
!function() {
  var d3 = {
    version: "3.5.6"
  };
...
var riot = require('riot');
module.exports = riot.tag('m-button', '<button type="{opts.type}" onclick="{click}" ><yield ></yield></button>', 'm-button button, [riot-tag="m-button"] button{ display: inline-block; color: black; background-color: #999999; border-color: #333333; margin-bottom: 0; padding: .5em 1em; font-size: 1.6rem; font-weight: 400; line-height: 1.2; text-align: center; vertical-align: middle; white-space: normal; border: 1.5px solid; border-radius: 5%; touch-action: manipulation; cursor: pointer; transition: background-color 300ms ease-out,border-color 300ms ease-out; } m-button button:hover, [riot-tag="m-button"] button:hover{ background-color:#cccccc; border-color: #666666; box-shadow: 0 0 10px #9ecaed; } m-button button:active, [riot-tag="m-button"] button:active{ background-color:#ffffff; border-color: #999999; }', function(opts) {
      this.text = opts.text;
